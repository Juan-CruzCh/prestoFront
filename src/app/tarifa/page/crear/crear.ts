...
export class Crear {
  ...
  rango1: new FormControl(0, { nonNullable: true, validators: [Validators.required, Validators.min(0)] }),
  rango2: new FormControl(0, { nonNullable: true, validators: [Validators.required, Validators.min(0)] }),
  costo: new FormControl(0, { nonNullable: true, validators: [Validators.required, Validators.min(0)] }),
  iva: new FormControl(0, { nonNullable: true, validators: [Validators.required, Validators.min(0)] }),
});
  ...
  async  btnGuardarTarifa(){
    ...
    const data:TarifaI = {
      ...
      rango:this.tarifas.map((item)=> ({costo:item.costo, iva:item.iva,rango1:item.rango1, rango2:item.rango2}))
